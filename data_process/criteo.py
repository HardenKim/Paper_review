...
def create_criteo_dataset(file, read_part=True, sample_num=100000, test_size=0.2):
    """
    ...
    # ====================================================
    # feature_columns = [sparseFeature(feature, int(data_df[feature].max()) + 1, embed_dim=embed_dim)
    #                     for feature in features]
    feature_columns = [sparseFeature(feature, int(data_df[feature].max()) + 1)
                        for feature in features]
